...
/****** Object:  Database [Landmark]    Script Date: 10/21/2017 4:44:56 PM ******/
CREATE DATABASE [Landmark]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Landmark', FILENAME = N'C:\Development\Landmark\Landmark.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Landmark_log', FILENAME = N'C:\Development\Landmark\Landmark_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Landmark] SET COMPATIBILITY_LEVEL = 130
GO
...
ALTER DATABASE [Landmark] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Landmark] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Landmark] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Landmark] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Landmark] SET QUERY_STORE = OFF
GO
